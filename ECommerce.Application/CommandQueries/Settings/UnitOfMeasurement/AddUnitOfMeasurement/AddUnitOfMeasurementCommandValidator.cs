...
{
    public class AddUnitOfMeasurementValidator : Validator<AddUnitOfMeasurementCommand>
    {
        #region Fields
        ...
        public AddUnitOfMeasurementValidator(IUnitOfMeasurementRepository unitOfMeasurementRepository)
        {
        ...
        public override ValidationResult Validate(AddUnitOfMeasurementCommand input)
        {
            _result
