...
{
    internal sealed class UpdateToDisableUnitOfMeasurementTypeCommandHandler : ICommandHandler<UpdateToDisableUnitOfMeasurementTypeCommand>
    {
        #region Fields
        ...
        public UpdateToDisableUnitOfMeasurementTypeCommandHandler(
        ...
        public async Task<Result> Handle(UpdateToDisableUnitOfMeasurementTypeCommand request, CancellationToken cancellationToken)
        {
            ...
            if (unitOfMeasurementType.Status != Status.Active.GetDescription())
                return Result.Failure<Result>(Error.Concurrency);
            unitOfMeasurementType.ToggleStatus(Status.Disabled.GetDescription());
